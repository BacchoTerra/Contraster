...
class PaletteAdapter (private val activity: Activity,val viewModel: MyPaletteViewModel,val layoutInflater: LayoutInflater): ListAdapter<MyPalette, PaletteAdapter.MyViewHolder>(PaletteComparator()) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        ...
        return MyViewHolder(RowPalettesBinding.inflate(LayoutInflater.from(parent.context),parent,false))
    }
    ...
    private fun showDeletionDialog(holder: MyViewHolder,myPalette: MyPalette) {
        ...
        dialogBinder.dialogDeletePaletteBtnDelete.setOnClickListener {
            ...
            alert.dismiss()
            Snackbar.make(holder.binder.root,R.string.snackBar_palette_deleted,Snackbar.LENGTH_SHORT).show()
        }
    ...
    private fun bindColors(holder: MyViewHolder,myPalette: MyPalette) {
        ...
        ImageViewCompat.setImageTintList(holder.binder.rowPaletteImageDelete, ColorStateList.valueOf(myPalette.foregroundColor))
        ...
        holder.binder.rowPaletteViewForegroundColor.backgroundTintList = ColorStateList.valueOf(myPalette.foregroundColor)
